...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(PROJECT_ROOT, 'database/shital'),                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = os.path.join(PROJECT_ROOT, 'sheetal')
